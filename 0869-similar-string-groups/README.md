<h2><a href="https://leetcode.com/problems/similar-string-groups/description/?envType=problem-list-v2&envId=nloyk6s1">869. Similar String Groups</a></h2><h3>Hard</h3><hr><p>Two strings, <code>X</code> and <code>Y</code>, are considered similar if either they are identical or we can make them equivalent by swapping at most two letters (in distinct positions) within the string <code>X</code>.</p>
